...
public enum RateService {
    ...
    BITSTAMP (6, "Bitstamp", "https://www.bitstamp.net/api/ticker/"),
    CRYPTOXCHANGE (7, "Crypto X Change", "http://cryptoxchange.com/api/v0/data/BTCUSD/ticker");
    ...
    public MtGoxTickerData parseJSON(JSONObject json) {
        ...
        switch (this) {
            ...
            case BITSTAMP:
                ...
                break;
            default:
                // Mt Gox: {"ticker":{"high":11.60000000,"low":10.88510000,"vol":624.15380000,
