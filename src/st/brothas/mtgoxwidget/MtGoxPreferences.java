...
public class MtGoxPreferences extends PreferenceActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d(Constants.TAG, "MtGoxPreferences.onCreate: ");
		// Cancelled until the user decides to add it
	...
	// Returns the default service if no RateService is found for this
	// appWidgetId
	...
	public static void deletePrefs(Context context, int appWidgetId) {
		Log.d(Constants.TAG, "MtGoxPreferences.deletePrefs: ");
		SharedPreferences sharedPreferences = context.getSharedPreferences("" + appWidgetId, Context.MODE_PRIVATE);
		SharedPreferences.Editor editor = sharedPreferences.edit();
		editor.clear();
		editor.commit();
